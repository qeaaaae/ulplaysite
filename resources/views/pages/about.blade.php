...
@section('content')
    ...
    <div class="pb-10 sm:pt-10 sm:pb-12">
        <div class="max-w-[1420px] mx-auto px-4 sm:px-6 md:px-8">
            <x-ui.section-heading tag="h1" icon="heroicon-o-information-circle" class="mb-2">О нас</x-ui.section-heading>
        </div>

        <section class="relative">
            <div class="lg:hidden mb-4">
                <div class="max-w-[1420px] mx-auto px-4 sm:px-6 md:px-8">
                    <div class="w-full bg-white rounded-xl border border-stone-200 shadow-sm p-4">
