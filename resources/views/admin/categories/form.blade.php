            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        @if($category->id)
                            <a href="{{ route('products.index', ['category' => $category->slug]) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-1 text-sm text-sky-600 hover:text-sky-700 hover:underline">
                                {{ $category->name }}
